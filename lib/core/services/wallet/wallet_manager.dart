...
///
/// Workflow:
/// 1. Create/Import wallet ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Save seed locally + Register public address to backend
/// 2. Switch wallet ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Load from local + Verify backend sync
/// 3. Delete wallet ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Remove from local + Backend
/// 4. Rename wallet ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Update local + Backend
class WalletManager {
  WalletManager._();
    ...
    try {
      ...
      try {
        ...
        try {
          ...
          debugPrint('[WalletManager] Failed to check existing wallets: $listError');
        }
      }
      ...
      for (final local in localWallets) {
        ...
        if (!exists) {
          ...
          try {
            ...
            debugPrint('[WalletManager] Auto-sync failed for ${local.name}: $e');
          }
        }
      }
    } catch (e) {
