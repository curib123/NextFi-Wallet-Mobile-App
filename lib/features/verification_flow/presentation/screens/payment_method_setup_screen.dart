...
import 'package:next_fi/core/services/payment_method_and_accounts/models/payment_method_and_accounts_dtos.dart';
...
class _EditPaymentAccountSheet extends StatefulWidget {
  ...
  @override
  State<_EditPaymentAccountSheet> createState() =>
      _EditPaymentAccountSheetState();
}
    ...
    try {
      await widget.paymentCore.editMyPaymentAccount(
        ...
        UpdateUserPaymentAccountRequest(
          paymentMethodId:
              widget.account.paymentMethod?.id ??
              widget.account.paymentMethodId,
